...
<head>
  ...
  <title>Beta Helpdesk v2 | Dashboard</title>
...
<body class="hold-transition sidebar-mini layout-fixed <?php if(!isset($_SESSION["user_id"])){ echo "login-page"; }?> ">
...
<div class="wrapper">
  ...
  <div class="preloader flex-column justify-content-center align-items-center">
    <img class="animation__wobble" src="dist/img/logo.svg" alt="Logo" height="80" width="auto">
  </div>
...
-->
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    -->
      <span class="brand-text font-weight-light"><b>Beta Helpdesk</b></span>
    </a>
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="./?view=contacts&opt=all" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Contactos</p>
                </a>
              </li>
